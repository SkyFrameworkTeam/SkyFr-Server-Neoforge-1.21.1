...
// Only constructed when the "luckperms" mod is actually loaded (see IslandCoreMod's constructor).
public class LuckPermsProvider implements PermissionProvider {
	...
	private User resolveUser(UUID playerUuid) {
		// Resolved lazily (not cached at construction/mod-init time): the loader doesn't guarantee
