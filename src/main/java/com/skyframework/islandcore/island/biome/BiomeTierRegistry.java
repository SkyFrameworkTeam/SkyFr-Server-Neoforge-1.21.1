...
public interface BiomeTierRegistry {
	...
	boolean canUse(UUID playerUuid, ResourceLocation biomeId, PermissionProvider permissionProvider);
	...
	List<BiomeTier> getTiersContaining(ResourceLocation biomeId);
	...
	Collection<ResourceLocation> getAvailableBiomes(UUID playerUuid, PermissionProvider permissionProvider);
